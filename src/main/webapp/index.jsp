              ...
              <div class="row">
                <div class="col-lg-10 col-md-11 mx-auto">
                  <div class="detail-box">
                    ...
                    <h3> Select a first Letter of Movie.</h3>
                     <%
                     for(int i=65;i<=90;i++)
                     {
                    	 %>
                   
                    	<h2> <a href="Movies.jsp?mname=<%=(char)i%>"><%=(char)i%></a></h2> 
        ...
        <div class="col-md-5 mx-auto">
          <div class="form_container">
            ...
            <form action="">
              ...
              <div class="form-row">
                <div class="form-group col">
                  <input type="text" class="message-box form-control" name="message" placeholder="Engter Feedback" />
                </div>
              </div>
              <div class="btn_box">
                <button>
